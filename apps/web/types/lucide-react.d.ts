...
// These are used to enable tree-shaking per React best practices

declare module 'lucide-react/dist/esm/icons/tree-deciduous' {
  import type { LucideIcon } from 'lucide-react';
  const TreeDeciduous: LucideIcon;
...
declare module 'lucide-react/dist/esm/icons/more-vertical' {
  import type { LucideIcon } from 'lucide-react';
...
declare module 'lucide-react/dist/esm/icons/file' {
  import type { LucideIcon } from 'lucide-react';
  const File: LucideIcon;
  export default File;
}

declare module 'lucide-react/dist/esm/icons/file-image' {
  import type { LucideIcon } from 'lucide-react';
  const FileImage: LucideIcon;
...
declare module 'lucide-react/dist/esm/icons/user-plus' {
  import type { LucideIcon } from 'lucide-react';
  const UserPlus: LucideIcon;
